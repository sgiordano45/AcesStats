...
(function() {
  ...
  document.head.insertAdjacentHTML('beforeend', teamColorCSS);
  
  function applyTeamColors() {
    const teams = {
      'black': 'team-text-black', 'green': 'team-text-green', 'red': 'team-text-red',
      'blue': 'team-text-blue', 'white': 'team-text-white', 'orange': 'team-text-orange',
      'silver': 'team-text-silver', 'purple': 'team-text-purple', 'gold': 'team-text-gold',
      'carolina': 'team-text-carolina', 'army': 'team-text-army'
    };
